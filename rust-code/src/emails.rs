...
use mail_parser::mailbox::mbox::ParseError;
use mail_parser::{mailbox::mbox::MessageIterator, parsers::fields::address::AddressParser, Addr};
...
impl EmailsMetrics {
    ...
    pub fn parse_emails(
        ...
        incubation_month_start_date: Option<NaiveDate>,
        incubation_month_end_date: Option<NaiveDate>,
        ignore_emails_from_addresses: Vec<&str>,
        ignore_emails_with_subject: Vec<&str>,
    ) -> EmailsMetrics {
        ...
        let mut emails_no_replies = 0;
        let mut emails_no_replies_word_count = 0;
        let mut emails_no_replies_characters = 0;
